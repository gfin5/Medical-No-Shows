...
The Data was analyzed on BigQuery first. The SQL queries can be found in the 'queries' tab and their results are in a folder in the 'data' folder. Notably, the age query has dynamic grouping using a "CASE WHEN" and the condition query has a "UNION ALL" to include all of the patients' conditions.
...
- The age group most likely to miss their appointments are young adults, likely because they aren't used to being in their own care. With the exception of children, who have parents to manage their appointments for them, likelihood to miss your appointment goes down with age.
